<?php
namespace Workstation\SampleModule\Model\ResourceModel\Item\Grid\Collection;

/**
 * Interceptor class for @see \Workstation\SampleModule\Model\ResourceModel\Item\Grid\Collection
 */
class Interceptor extends \Workstation\SampleModule\Model\ResourceModel\Item\Grid\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, $mainTable = 'workstation_sample_item', $resourceModel = 'Workstation\\SampleModule\\Model\\ResourceModel\\Item')
    {
        $this->___init();
